...
> = {
  "toggle-play": { description: "播放/暂停", category: "播放控制" },
  "stop-playback": { description: "停止播放", category: "播放控制" },
  "seek-forward": {
  ...
  "goto-start": { description: "跳转到时间线开始", category: "导航" },
  "goto-end": { description: "跳转到时间线结束", category: "导航" },
  "split-element": {
  ...
  "toggle-snapping": { description: "切换对齐", category: "编辑" },
  undo: { description: "撤销", category: "历史记录" },
  redo: { description: "重做", category: "历史记录" },
  "copy-selected": {
    description: "复制选中的元素",
    category: "编辑",
  },
